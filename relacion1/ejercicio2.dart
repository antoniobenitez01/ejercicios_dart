...
void main()
{
  ...
  print("\nDeclarando variable tipo 'double' ...");
  ...
  print("\nDeclarando variable tipo 'bool' ...");
  bool boolvar = true;
  print("Variable 'boolvar' = $boolvar");

  print("\nDeclarando variable tipo 'dynamic' ...");
  ...
  print("\n====== COLECCIONES ======");
  print("\nCreando colección de tipo 'List' ...");
  List lista = [25,5,10];
  ...
  print("\nCreando colección de tipo 'Record' ...");
